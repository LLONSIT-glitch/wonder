...
DECLARE_SEGMENT(audioTblStart);
DECLARE_SEGMENT(audioBankStart);
DECLARE_SEGMENT(audioSequences);
DECLARE_SEGMENT(F24E0);
DECLARE_SEGMENT(SpriteSeg1);
DECLARE_SEGMENT(SpriteSeg2);
DECLARE_SEGMENT(SpriteSeg3);
DECLARE_SEGMENT(F27E0);
DECLARE_SEGMENT(Seg_639B20);
DECLARE_SEGMENT(Seg_69A970);
DECLARE_SEGMENT(Seg_6E3A40);
DECLARE_SEGMENT(Seg_6A69E0);
