...
static void func_800C055C(int arg0);
...
static void func_800C0278(int arg0) {
    if (D_8016047C == 8) {
        D_8016047C = 0;
        D_8016044C += 1;
    }
...
static void func_800C0108(int arg0) {
    if (D_80160484 == 0) {
...
static void func_800C0194(void) {
    if (D_80160484 != 0) {
        D_8016043C += 1;
        D_80160484 = 0;
    }
...
static void func_800C03C8(void) {
    while (D_8016047C != 8) {
        *D_8016044C *= 2;
        D_8016047C += 1;
    }
...
static int func_800C0534(int arg0) {
...
static void CompressSPI(SPI_VERSION spiType, int size) {
    UNUSED int pad;
