...
s32 func_8001173C(UnkStruct_8000DDE0* arg0) {
    ...
    sp3C->unk8 = func_800B202C(&sp3C->unkC, &sp3C->unk10, (sp3C->unk2 << 0x10) | (s16) sp3A, 
                               sp3C->unk4, sp3C->unkC->unkCC, sp3C->unkC->unkD0, (u8) (s32) sp39);
...
s32 func_80012164(UnkStruct_8000DDE0* arg0) {
    ...
    ;
    if ((sp48->unk7C = func_80049A00(sp48->unkC, sp48->unk10, sp4C[1], sp4C[2], 
                                (s32) sp4C[3], sp48->unk8, sp48->unk10->unk0 & 1 ? 0 : 1,
                                sp44, (s32) sp48->unk4)) == 0) {
        return -1;
    }
    sp48->unk0 |= 1;
    return 0;
...
s32 func_80013C90(UnkStruct_8000DDE0* arg0) {
    ...
    if (sp28[2] != 0) {
        ...
        for (sp38 = 0, sp20 = sp24->unkC; sp38 < sp24->unk6; sp38++, sp20++) {
            ...
            SysMem_Copy8(&sp20->currentPaletteColors[sp24->unk86], &(&sp20->currentPaletteColors[sp24->unk88])[(s16) sp24->unk90 * sp24->unk8E], sp24->unk8A * 2);
        }
        sp24->unk0 |= 0x1000;
    } else {
        sp24->unk0 &= ~0x1000;
