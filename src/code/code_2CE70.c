...
void func_8002C2F8(void) {
    ...
    sp70->unk24.x = sp70->unk24.z = sp70->unkC.x = sp70->unkC.y = sp70->unk0.x = sp70->unk0.y = sp70->unk0.z = 0.0f;
    func_800B1250(&gDisplayListHead, sp70, 0U);
    MtxUtil_Identity(0);
    MtxUtil_TranslateLocal((f32) ((f64) D_80181618 * 0.208), (f32) ((f64) D_80181624 * 0.25), -60.0f);
    if (D_8018163C >= 10) {
    ...
    switch (D_8018163C) {
        case 1:
            ...
            MtxUtil_RotateY((D_80181354 += 10.0 * D_8018257C));
            MtxUtil_RotateX((D_801812A0 -= 14.0 * D_8018257C));
            break;
        case 2:
        ...
        case 3:
            ...
            MtxUtil_RotateY((D_80181354 += 10.0 * D_8018257C));
            MtxUtil_RotateX((D_801812A0 -= 15.0 * D_8018257C));
            D_80181618 += D_80189618 * D_8018257C;
        ...
        case 10:
            ...
            MtxUtil_RotateY((D_80181354 += (15.0 * D_8018257C)));
            MtxUtil_RotateX((D_801812A0 -= (20.0 * D_8018257C)));
        ...
        case 11:
            ...
            MtxUtil_RotateZ(D_801813C8);
            MtxUtil_RotateX(D_801812A0);
    ...
    if (spAE != 0) {
        MtxUtil_ScaleAxes(D_801815D0, D_801815D0, D_801815D0);
        func_8002D200();
    }
}
