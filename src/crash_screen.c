...
// Libultra functions reimplemenation
...
OSThread* Fault_GetCrashedThread(void) {
    OSThread* queue = GetCurrFaultedThread();
...
void Fault_ThreadEntry(void* arg) {
    ...
    osSyncPrintf("Setting events in fault_thread_entry!\n");
...
void Fault_SetFrameBuffer(void* buffer, u16 width, u16 height) {
